...
public sealed class SalesforceOptions
{
    ...
    public string AuthorizationEndpoint { get; set; } = "https://obg--venkat.sandbox.my.salesforce.com/services/oauth2/authorize";
    public string TokenEndpoint { get; set; } = "https://obg--venkat.sandbox.my.salesforce.com/services/oauth2/token";
